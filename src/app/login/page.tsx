  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#101416] p-4">
      <Card className="w-full max-w-md bg-[#1d2022] border-[#424753]/30 text-[#e0e3e6]">
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-[#adc6ff]">Log in to PrepPath</CardTitle>
        ...
        <CardContent>
          <form>
            <div className="flex flex-col gap-4">
              ...
              <Button formAction={login} type="submit" className="w-full bg-[#adc6ff] hover:bg-[#d8e2ff] text-[#001a41] font-bold">
                Login
              </Button>
        ...
        <CardFooter className="flex justify-center">
          <div className="text-sm text-[#c2c6d5]">
            ...
            <Link href="/signup" className="text-[#4d8efe] hover:underline">
              Sign up
            </Link>
          </div>
        </CardFooter>
