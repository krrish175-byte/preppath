      ...
      <div className="w-full max-w-md relative z-10 glass-card rounded-[2rem] p-8 md:p-10 border border-white/10 shadow-2xl">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-white/60">
            Join PrepPath to start your preparation
          </p>
        </div>
        ...
        <form className="space-y-6">
          ...
          <Button formAction={signup} type="submit" className="w-full btn-verdant h-12 rounded-xl font-bold text-lg shadow-[0_0_20px_rgba(212,248,122,0.2)] hover:shadow-[0_0_30px_rgba(212,248,122,0.4)] transition-all">
            Sign Up
          </Button>
        </form>
        ...
        <div className="mt-8 text-center text-sm text-white/60">
          ...
          <Link href="/login" className="text-[#D4F87A] font-semibold hover:text-white transition-colors">
            Log in
          </Link>
        </div>
      </div>
